...
> Note: This package is early in development and is being maintained by academics, not software developers! Please bear with us as we figure things out, and check that outputs are reasonable.  Let us know if you would like to contribute, all are welcome! 

## Installation

tidymito is not (yet?) on CRAN, but you can install the development version of tidymito from [GitHub](https://github.com/) with:
